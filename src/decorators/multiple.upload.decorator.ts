...
export function MultipleUploadDecorator({ type, width, height, minCount, maxCount } : {
...
export function MultipleUploadDecorator({ type, handlePicture, minCount, maxCount } : {
	type: UploadType.PICTURE,
	handlePicture: (sharp) => any,
	minCount?: number,
	maxCount?: number,
}) : any;
export function MultipleUploadDecorator({ type, minCount, maxCount } : {
	type: Omit<UploadType, UploadType.PICTURE> | Array<Omit<UploadType, UploadType.PICTURE>>,
	minCount?: number,
	maxCount?: number,
}) : any;
export function MultipleUploadDecorator({ type, width, height, handlePicture, minCount, maxCount }) {
